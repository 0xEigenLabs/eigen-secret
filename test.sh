...
npx hardhat create-account --alias Bob --index 2 --network $NETWORK
...
npx hardhat deposit --alias Bob --index 2 --value 10 --asset-id ${ASSET_ID} --network $NETWORK
npx hardhat deposit --alias Bob --index 2 --value 10 --asset-id ${ASSET_ID} --network $NETWORK
npx hardhat get-balance --alias Bob --index 2 --asset-id ${ASSET_ID} --network $NETWORK
